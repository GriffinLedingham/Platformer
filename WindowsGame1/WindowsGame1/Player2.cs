...
namespace WindowsGame1
{
    public class Player2
    {
        ...
        public Player2(ContentManager Content, SpriteBatch spriteBatch)
        {
            this.Content = Content;
            this.spriteBatch = spriteBatch;
            SpriteTexture = Content.Load<Texture2D>("player2f1");
        ...
        public void update()
        {
            ...
            if (frameSkip == 8)
            {
                if (stillFrame)
                {
                    SpriteTexture = Content.Load<Texture2D>("player2f2");
                    stillFrame = false;
                }
                else
                {
            ...
            GamePadState currentState = GamePad.GetState(PlayerIndex.Two);
        ...
        public bool CheckCollision(Player2 s, Item i)
        {
            float leftA, leftB;
            float rightA, rightB;
            float topA, topB;
